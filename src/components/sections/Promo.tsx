...
export const Promo = () => {
  return (
    <section className="py-24 px-6 relative overflow-hidden">
      <div className="absolute inset-0 bg-brand-sage -z-10" />
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8 bg-white/5 backdrop-blur-md p-12 md:p-20 rounded-[4rem] border border-white/20 shadow-2xl">
        <motion.div
          initial={{ scale: 0 }}
          whileInView={{ scale: 1 }}
          className="inline-flex items-center gap-2 bg-brand-gold text-white px-6 py-2 rounded-full font-bold uppercase tracking-widest text-sm"
        >
